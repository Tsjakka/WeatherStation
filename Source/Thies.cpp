...
const byte windSpeedPin = 12;             // The interrupt pin used for the wind speed
...
/*
  ...
  The Thies anemometer gives 800 Hz pulses at its maximum wind speed of 40 m/s (20 Hz = 1 m/s).
*/
...
short Thies::calculateWindDirection(int analogValue) {
  ...
  else if (analogValue >=  681 && analogValue <  885) result = 12;
  else if (analogValue >=  885 && analogValue < 1054) result = 11;
  else if (analogValue >= 1054 && analogValue < 1204) result = 10;
  else if (analogValue >= 1204 && analogValue < 1375) result = 9;
  ...
  else if (analogValue >= 1919 && analogValue < 2040) result = 4;
  else if (analogValue >= 2040 && analogValue < 2161) result = 3;
  else if (analogValue >= 2161 && analogValue < 2246) result = 2;
  else if (analogValue >= 2246 && analogValue < 2331) result = 1;
  else if (analogValue >= 2331                      ) result = 0;
